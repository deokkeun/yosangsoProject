...
<body>
                ...
                <section class="content-box-left">
                    ...
                    <section class="content-box-left-title">
                        <div class="person-img">
                            <img src="../assets/인체이미지누끼.png" alt="인체이미지" width="80px">
                            <img src="../assets/people/brain.png" alt="두뇌" class="person-img-heart">
                        </div>
                        <div>
                            <div class="title-sub">
    ...
    <!-- people.js 연결 -->
    <script src="${contextPath}/resources/js/product/people.js"></script>
</body>
</html>